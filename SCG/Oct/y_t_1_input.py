...
# add y_t-1
col_selected = np.concatenate(([149], col_selected), axis=0)
...
for day in range(test_days):
    ...
    trainX, trainY = inputs[train_from-1:train_end-1, :], outputs[train_from:train_end]
