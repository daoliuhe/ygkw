...
1/11/2016
Do scaling in the right way

3/11/2016
Try neural network
Remark:
    a. activation='relu', solver='lbfgs'
    b. no. of hidden nodes: 15 (rmse=0.69), 20 (rmse=0.48)
    c. pay attention to plot of them
    d. NN can produce close result to linear regression
